...
var count=document.createElement('script');count.type='text/javascript';count.async=true;count.src='//hello.myfonts.net/count/27bd76';var s=document.getElementsByTagName('script')[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if(typeof(woffEnabled)=='undefined'){var woffEnabled=true;}
...
suffix="_unhinted";var fonts=[{"fontFamily":"Geometric415BT-LiteA","url":wfpath+"27BD76_0"+suffix+"_0."+webfontType},{"fontFamily":"Geometric415BT-MediumA","url":wfpath+"27BD76_1"+suffix+"_0."+webfontType},{"fontFamily":"Geometric415BT-BlackA","url":wfpath+"27BD76_2"+suffix+"_0."+webfontType}];var len=fonts.length;if(webfontType=="ttf"){var data_fn=suffix=="_unhinted"?"27BD76_data_unhintedttf.css":"27BD76_datattf.css";document.write("<link rel='stylesheet' type='text/css' href='"+wfpath+data_fn+"'>");}
else if(webfontType=="woff"){var data_fn=suffix=="_unhinted"?"27BD76_data_unhintedwoff.css":"27BD76_datawoff.css";document.write("<link rel='stylesheet' type='text/css' href='"+wfpath+data_fn+"'>");}
