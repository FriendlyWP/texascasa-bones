...
SCRIPTS & ENQUEUEING
*********************/
// SET VARIABLE TO CHECK IF RESOURCE TABLE TEMPLATE PART IS BEING CALLED
global $temppart;
$temppart = false;
...
function bones_scripts_and_styles() {
  if (!is_admin()) {
    ...
    // IF THE RESOURCE TABLE TEMP PART IS BEING CALLED
    global $temppart;
    if ( $temppart == 'true' ) {

        //adding scripts file in the footer
        wp_register_script( 'datatables', 'http://ajax.aspnetcdn.com/ajax/jquery.dataTables/1.9.4/jquery.dataTables.min.js', array( 'jquery' ), '', true );

        wp_register_script( 'yadcf', get_template_directory_uri() . '/library/js/yadcf-master/jquery.dataTables.yadcf.js', array( 'jquery' ), '', true );

        wp_register_style( 'datatables-css', 'http://ajax.aspnetcdn.com/ajax/jquery.dataTables/1.9.4/css/jquery.dataTables.css', array(), '' );
...
function bones_ancillary_nav() {
    ...
    wp_nav_menu(array(
    	...
    	'menu_class' => 'nav ancillary-nav clearfix',         // adding custom nav class
...
// the social menu
function bones_social_nav() {
	// display the wp3 menu if available
    wp_nav_menu(array(
    	'container' => false,                           // remove nav container
    	'container_class' => 'menu clearfix',           // class of container (should you choose to use it)
    	'menu' => 'The Social Menu',                      // nav name
    	'menu_class' => 'social-nav clearfix',         // adding custom nav class
